...
class AchievementCreate(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AchievementCreate:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AchievementCreate:
        """Create an instance of AchievementCreate from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AchievementCreate.parse_obj(obj)

        _obj = AchievementCreate.parse_obj({
            "name": obj.get("name"),
