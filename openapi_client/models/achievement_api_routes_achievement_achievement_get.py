...
class AchievementApiRoutesAchievementAchievementGet(BaseModel):
    """
    AchievementApiRoutesAchievementAchievementGet
    """
    ...
    __properties = ["id", "name", "description", "picture", "owner_user_id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AchievementApiRoutesAchievementAchievementGet:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AchievementApiRoutesAchievementAchievementGet:
        """Create an instance of AchievementApiRoutesAchievementAchievementGet from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AchievementApiRoutesAchievementAchievementGet.parse_obj(obj)

        _obj = AchievementApiRoutesAchievementAchievementGet.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
