...
class AchievementEdit(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AchievementEdit:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AchievementEdit:
        """Create an instance of AchievementEdit from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AchievementEdit.parse_obj(obj)

        _obj = AchievementEdit.parse_obj({
            "name": obj.get("name"),
